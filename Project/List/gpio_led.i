...
void WriteData_8(u8 Data_8)
{
	...
	for (i = 0;i<8;i++ )
	{
		...
		{
			GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)),PinNum,Bit_SET);
		}
		else if ((PinNum&Data_8) == ~PinNum)
		{
			GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)),PinNum,Bit_RESET);
		}
		PinNum = PinNum<<1;
	}
}
...
u8 ReadData_8(void)
{
	...
	PinVal = GPIO_ReadInputData(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)));
	DataVal = PinVal;
	return DataVal;
}
...
void LED_Display(void)
{
	...
	GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)),((uint16_t)0x0400));
	Delay(0xfffff);
	GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)),((uint16_t)0x0400));
}
...
void Key_Test(void)
{
	...
	if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),((uint16_t)0x0100)) == Bit_RESET)
	{
	    GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)),((uint16_t)0x0001));    
	}
	else if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),((uint16_t)0x0100)) == Bit_SET)
	{
	    GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)),((uint16_t)0x0001));    
	}
	 
	if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1400)),((uint16_t)0x0008)) == Bit_RESET)
	{
	    Delay(0xfffff);
		if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1400)),((uint16_t)0x0008)) == Bit_RESET)
		{
	...
	if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)),((uint16_t)0x0008)) == Bit_RESET)
	{
	    Delay(0xffff);
		if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)),((uint16_t)0x0008)) == Bit_RESET)
		{
